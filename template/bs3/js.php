...
$(document).ready(function(){
  var msg="<marquee style='margin-top:8px' id=broadcast scrollamount=1 scrolldelay=50 onMouseOver='this.stop()'"+
  ...
  $("body").append("<div id=footer class=center style='font-size:5px' >MINCODINGSCHOOL WITH GPLv2 licensed by HUSTOJ</a> "+(new Date()).getFullYear()+" </div>");
});
