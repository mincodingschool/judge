<?php
	...
	$MSG_Accepted="정답";
	$MSG_Presentation_Error="출력형태 Error";
	$MSG_Wrong_Answer="오답";
	$MSG_Time_Limit_Exceed="시간초과";
	$MSG_Memory_Limit_Exceed="메모리초과";
	...
	$MSG_Runtime_Click="Runtime Error(클릭)";
	$MSG_Compile_Click="Compile Error(클릭)";
	$MSG_Click_Detail="세부내용 확인하기(클릭)";
	$MSG_Compile_OK="Compile 성공";
	$MSG_RUNID="RunID";
	$MSG_USER="User";
	$MSG_PROBLEM="Problem";
	$MSG_RESULT="Result";
   ...
   $MSG_Explain="Type reason or explaination";
	...
	$MSG_USER_ID="아이디";
	$MSG_PASSWORD="비밀번호";
	$MSG_REPEAT_PASSWORD="비밀번호 재입력";
	$MSG_SCHOOL="소속 및 학교";
	$MSG_EMAIL="Email";
	$MSG_REG_INFO="민선생코딩스쿨 회원가입";
